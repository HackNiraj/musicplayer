        ...
        switch (holder.getItemViewType()) {
            ...
            case TYPE_USER:
                ...
                try {
                    Glide.with(context)
                            ...
                            .apply(RequestOptions.placeholderOf(context.getResources().getDrawable(R.drawable.ic_user_placeholder)))
            ...
            case TYPE_PLAYLIST:
                ...
                Glide.with(context)
                        ...
                        .apply(RequestOptions.placeholderOf(R.drawable.ic_playlist))
                        .apply(RequestOptions.centerCropTransform())
